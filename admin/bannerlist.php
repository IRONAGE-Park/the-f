...
<div id="admin-upload-shade">
  <div class="admin-upload-box">
    <form class="admin-upload-form" name="signform" method="post" action="<?echo" $_SERVER[PHP_SELF]?c_name=banner"?>" ENCTYPE="multipart/form-data">
      <input type="hidden" name="formmode" value="save">
      <input type="hidden" name="conf" value="banner"><!-- 환경설정파일  -->
      ...
      <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="55" align="right"><button class="admin-button submit">제출</button>
              <a class="admin-button" href="javascript:uploadToogleSwitch('#admin-upload-shade');">
                취소
              </a>
            </td>
          </tr>
...
<div id="admin-mupload-shade">
  <div class="admin-upload-box">
    <form class="admin-upload-form" name="signform" method="post" action="<?echo" $_SERVER[PHP_SELF]?c_name=banner"?>" ENCTYPE="multipart/form-data">
      <input type="hidden" name="formmode" value="save">
      <input type="hidden" name="conf" value="mbanner"><!-- 환경설정파일  -->
      <input type="hidden" name="bmain" value="ok">
      <table border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="50" width="150">
      ...
      <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="55" align="right"><button class="admin-button submit">제출</button>
              <a class="admin-button" href="javascript:uploadToogleSwitch('#admin-mupload-shade');">
                취소
              </a>
            </td>
          </tr>
    ...
    <?
      for ( $i=0 ; $i<$rcount ; $i++ ) {
		  $link_page = "";
			...
			$board_img = "$HOME_PATH/upload/banner/".$result[$i]['fileadd_name'];
		?>
    ...
    <table style="border:none;" width="200" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="160" align="center">
          <a href="javascript:swal('삭제하시겠습니까?', {
                    dangerMode: true,
                    buttons: true
                  }).then((value) => {
                    if (value) {
                      location.href = './?c_name=banner&bmain=ok&conf=<?=$conf?>&formmode=delete&uid=<?=$result[$i]['uid']?>';
                    }
                  });">
  ...
  <td>
    <table style="border:none;" width="200" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="160" align="center">
          <div class="admin-image-box">
            <a href="javascript:uploadToogleSwitch('#admin-upload-shade');">
...
<table style="border:none;" cellpadding="0" cellspacing="0">
  ...
  for ( $i=0 ; $i<$m_rcount ; $i++ ) {
    ...
    $board_img = "$HOME_PATH/upload/mbanner/".$m_result[$i]['fileadd_name'];
	?>
  <td>
      ...
      <tr>
        <td height="200" align="center">
          <a href="javascript:swal('삭제하시겠습니까?', {
                    ...
                    if (value) {
                      location.href = './?c_name=banner&bmain=ok&conf=m<?=$conf?>&formmode=delete&uid=<?=$m_result[$i]['uid']?>';
                    }
                  });">
  ...
  <td>
    <table style="border:none;" width="160" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="200" align="center">
          <div class="admin-image-box mobile">
            <a href="javascript:uploadToogleSwitch('#admin-mupload-shade');">
